  ...
  return (
    <div className="trainer-video-login">
      ...
      <div className="trainer-login-content">
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="trainer-field">
              <label className="trainer-label" htmlFor="trainer-email">Username or Email</label>
            ...
            <div className="trainer-field">
              <label className="trainer-label" htmlFor="trainer-password">Password</label>
              <div className="trainer-input-wrap">
        ...
        <p className="trainer-footer">© 2026 · WaveInit LMS · Trainer Portal</p>
      </div>
    </div>
  )
}
